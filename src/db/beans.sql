...
--Usuarios
INSERT INTO `colegcat_qa_system`.`users` (`id`, `name`, `email`, `password`, `isActive`, `createdAt`, `updatedAt`, `idRole`, `idAcudiente`) VALUES ('1', 'Acudiente Tecnopac', 'acudiente@gmai.com', '$2a$10$a3sbS0EB0jUYKM9WHtKTyusajTsfvaa8edLg1dmXRnEwKFtle9yse', '1', '2024-04-21 20:00:00', '2024-04-21 20:00:00', '1', '1');
INSERT INTO `colegcat_qa_system`.`users` (`id`, `name`, `email`, `password`, `isActive`, `createdAt`, `updatedAt`, `idRole`, `idAcudiente`) VALUES ('2', 'Admin Tecnopac', 'admin@gmail.com', '$2a$10$a3sbS0EB0jUYKM9WHtKTyusajTsfvaa8edLg1dmXRnEwKFtle9yse', '1', '2024-04-21 20:00:00', '2024-04-21 20:00:00', '1', '1');
