...
router.get('/listarStudentDatabase/:nombres/:tipo',StudentDatabaseCtrl.consultarStudentDatabase);
router.get('/listarStudentDatabaseEstado/:tipo',StudentDatabaseCtrl.consultarStudentEstados);
